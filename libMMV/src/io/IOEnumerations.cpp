...
namespace ettention
{
    CoordinateOrder parseVoxelCoordinateOrder(const std::string& coordinateOrder)
    {
        ...
        {
            throw std::runtime_error("Unknown coordinate order: " + coordinateOrder + "!");
        }
    }
    ...
    VoxelValueType parseVoxelValueType(const std::string& voxelValueType)
    {
        ...
        {
            throw std::invalid_argument("ParseVoxelValueType: Unknown file mode ");
        }
    }
    ...
    size_t getVoxelValueSizeInBytes(VoxelValueType type)
    {
        ...
        throw std::invalid_argument("GetVoxelValueSizeInBytes: wrong voxel type ");
    }
